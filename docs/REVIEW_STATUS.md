...
**Status:** ZAVRŠEN — prihvaćen od vlasnika projekta 2026-07-30
...
- [x] Sve `ETORO_*` promenljive u `.env.example`; `ETORO_ALLOW_WRITE=false`;
      `ETORO_BEARER_TOKEN` uklonjen (autentikacija: `x-api-key`, `x-user-key`,
      `x-request-id`)
